...
function spriteChangeDirection(sprite: Sprite) {
    ...
    if (player != undefined) {
        if (mp.isButtonPressed(player, mp.MultiplayerButton.Up) && mp.isButtonPressed(player, mp.MultiplayerButton.Left)) {
            sprites.setDataNumber(sprite, "dir", 0)
        } else if (mp.isButtonPressed(player, mp.MultiplayerButton.Up) && mp.isButtonPressed(player, mp.MultiplayerButton.Right)) {
            sprites.setDataNumber(sprite, "dir", 2)
        } else if (mp.isButtonPressed(player, mp.MultiplayerButton.Up)) {
            sprites.setDataNumber(sprite, "dir", 1)
        } else if (mp.isButtonPressed(player, mp.MultiplayerButton.Down) && mp.isButtonPressed(player, mp.MultiplayerButton.Left)) {
            sprites.setDataNumber(sprite, "dir", 5)
        } else if (mp.isButtonPressed(player, mp.MultiplayerButton.Down) && mp.isButtonPressed(player, mp.MultiplayerButton.Right)) {
